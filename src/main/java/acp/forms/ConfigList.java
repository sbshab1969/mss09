...
public class ConfigList extends FrameList {
  ...
  private ConfigManagerList listManager;
  private ConfigManagerEdit editManager;
  ...
  public ConfigList() {
    ...
    // Table ---
    listManager = new ConfigManagerList();
    editManager = new ConfigManagerEdit();
  ...
  public void initForm() {
    String queryCbdb = editManager.selectSources();
