...
public class VarList extends FrameList {
  ...
  private VarManagerList listManager;
  private VarManagerEdit editManager;
  ...
  public VarList() {
    ...
    // Table ---
    listManager = new VarManagerList();
    editManager = new VarManagerEdit();
    ...
    // pnlTable.getTable().setDefaultRenderer(Date.class, new DateTimeRenderer());
