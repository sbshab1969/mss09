...
public class XmlTableList extends FrameList {
  ...
  private ToptionManagerList listManager;
  private ToptionManagerEdit editManager;
  ...
  public XmlTableList(String keyTitle, String path, ArrayList<String> attrs) {
    ...
    // --- Table ---
    listManager = new ToptionManagerList(path, attrs);
    editManager = new ToptionManagerEdit(path, attrs);
...
//  pnlTable.setRecPerPage(3);
  ...
  public void initForm() {
    String queryCbdb = listManager.selectSources();
